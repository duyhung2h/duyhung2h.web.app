export class Article {
  ...
  private _articleViewCount: number;
  ...
  constructor(
    ...
    this._lastUpdatedDate = lastUpdatedDate;
    this._articleViewCount = articleViewCount;
  }

  /**
   * Getter articleViewCount
   * @return {number}
   */
  public get articleViewCount(): number {
    return this._articleViewCount;
  }

  /**
   * Setter articleViewCount
   * @param {number} value
   */
  public set articleViewCount(value: number) {
    this._articleViewCount = value;
  }
